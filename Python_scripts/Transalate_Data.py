...
with engine.connect() as conn:
    try:
        ...
        gc = gspread.service_account("C:/Users/Anonymous/Documents/Project/Data_analysis/Scripts/Python_scripts/service_account.json")

        loop_counter = 0
        chunk_size = 100
        file_name = 'OTODOM_ANALYSIS_'
        user_email = 'sachinpareek21874@gmail.com'
